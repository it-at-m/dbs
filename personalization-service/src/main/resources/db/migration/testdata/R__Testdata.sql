...
truncate service_finder CASCADE;
...
INSERT INTO service_finder(service_id, last_update, title, note) VALUES
('service1', NOW(), 'Item 1', 'Note for Item 1'),
('service2', NOW(), 'Item 2', 'Note for Item 2'),
('service3', NOW(), 'Item 3', 'Note for Item 3')