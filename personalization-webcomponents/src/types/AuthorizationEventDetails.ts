...
export type KEYCLOAK_AUTH_LEVEL = typeof KEYCLOAK_AUTH_LEVEL1 | typeof KEYCLOAK_AUTH_LEVEL3 | typeof KEYCLOAK_AUTH_LEVEL4;

export default class AuthorizationEventDetails {

  constructor(buergerName: string, buergerMail: string, loginProvider: string, trustLevel: KEYCLOAK_AUTH_LEVEL, accessToken: string) {
