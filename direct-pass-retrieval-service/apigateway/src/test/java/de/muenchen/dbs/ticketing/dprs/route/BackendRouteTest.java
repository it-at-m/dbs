 ...
 */
package de.muenchen.dbs.ticketing.dprs.route;
...
class BackendRouteTest {
    ...
    //TODO wie macht man das jetzt? Bekomme immer 401 weil ich kein valides cookie mitschicke
    //    @Test
    @WithMockUser
    void backendRouteResponse() {
        webTestClient.get().uri("/api/mpdz-ticketing-fragments-backend-service/remote/endpoint")
