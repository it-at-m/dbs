...
public class GuiConfiguration {
    ...
    @Bean
    public RouterFunction<ServerResponse> scriptRouter(
            @Value("classpath:/static/mpdz-ticket-fragment.mjs") final Resource script) {
        log.debug("Script: {}", script);
        return route(GET("/mpdz-ticket-fragment.mjs"),
                request -> ok().contentType(MediaType.parseMediaType("application/javascript"))
                        .bodyValue(script));
    }
